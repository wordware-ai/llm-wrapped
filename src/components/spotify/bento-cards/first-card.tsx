...
export default function FirstCard({ content }: { content?: string }) {
  return (
    <div className="relative flex h-[400px] w-full items-center justify-center overflow-hidden rounded-xl border-2 bg-[#1451E0] lg:h-[35%]">
      ...
      <Image
        ...
        className="absolute left-0 h-max"
        alt="blob"
        width={400}
        height={400}
      />
