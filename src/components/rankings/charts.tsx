...
export function CumulativeUsersChart({
  ...
  chartData: { timestamp: string; cumulative: number }[];
}) {
  return (
    <Card className="w-full max-w-4xl">
      <CardHeader className="flex flex-col items-stretch space-y-0 border-b p-0 sm:flex-row">
        <div className="flex flex-1 flex-col justify-center gap-1 px-6 py-5 sm:py-6">
          ...
          <CardDescription>
            Showing total number of users since the launch
          </CardDescription>
        </div>
        <div className="relative z-30 flex flex-1 flex-col justify-center gap-1 border-t px-6 py-4 text-left even:border-l data-[active=true]:bg-muted/50 sm:border-l sm:border-t-0 sm:px-8 sm:py-6">
          <span className="text-xs text-muted-foreground">Total Users</span>
          <span className="text-lg font-bold leading-none sm:text-3xl">
            {chartData[chartData.length - 1].cumulative.toLocaleString()}
          </span>
        </div>
      </CardHeader>
      <CardContent>
  ...
  return (
    <Card className="w-full max-w-4xl">
      <CardHeader>
        ...
        <CardDescription>
          Showing user growth hour-by-hour (virality metric)
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer
        ...
        >
          ...
          >
            ...
            />
            <Bar dataKey={"unique"} fill={`var(--color-unique)`} />
          </BarChart>
        </ChartContainer>
      </CardContent>
      {/* <CardFooter>
...
export function TrafficChart({
  ...
  chartData: { timestamp: string; traffic: number }[];
}) {
  return (
    <Card className="w-full max-w-4xl">
      <CardHeader>
        ...
        <CardDescription>
          Showing website traffic hour - by - hour
        </CardDescription>
      </CardHeader>
      <CardContent>
        <ChartContainer
